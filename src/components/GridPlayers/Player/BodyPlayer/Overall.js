...
export default function Overall({player}) {
  return (
      <>
        ...
        />
        <Card.Title data-tip="Proporción entre bajas realizadas y muertes"><img className='img-kd' src={kdImg} alt="k/d"></img>{player.overall ? player.overall.kd : ''}</Card.Title>
